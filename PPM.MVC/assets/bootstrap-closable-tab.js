var closableTab = {
	...
	frameLoad:function (frame){
            ...
            var mainheight = $(frame).contents().find('.page-container').height();
	...
	addTab:function(tabItem){ //tabItem = {id,name,url,closable}
		...
		if(!$('#'+id)[0]){
			var li_tab = '<li role="presentation" class="" id="'+id+'"><a href="#'+container+'"  role="tab" data-toggle="tab" style="position: relative;padding:2px 20px 2px 15px;margin-top:4px;">'+tabItem.name;
			if(tabItem.closable){
